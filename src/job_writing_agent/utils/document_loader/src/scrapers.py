...
URL = (
    "https://job-boards.greenhouse.io/ocrolusinc/jobs/5837904004?gh_src=t9eal4"
)
...
def extract_job_description(page: Page):
    """Extract the job description from the page."""
    job_description = page.query_elements("""
                                          {
...
def main():
    with (
        ...
        # login_button_element = page.get_by_prompt("Find the login button")

        # print(login_button_element)

        # if login_button_element:
        #     login_button_element.click()

        # user_name_field = page.query_elements("""
        #                                       {
        #                                         find_user_name_field
        #                                     }""")
        # user_name_field.find_user_name_field.type("test@test.com", delay=200)

        # password_field = page.query_elements("""
        #                                       {
        #                                         find_password_field
        #                                     }""")
        # password_field.find_password_field.type("test@test.com", delay=200)

        # login_button = page.query_elements("""
        #                                       {
        #                                         find_login_button
        #                                     }""")
        # login_button.find_login_button.click()
