...
def company_research_data_summary(state: ResearchState) -> dict[str, Any]:
    ...
    try:
        # Update current node
        updated_state = {**state.__dict__, "current_node": "company_research_data_summary"}
        ...
        updated_state["company_research_data"] = CompanyResearchData(**updated_company_research_data)
    ...
    if not is_valid:
        ...
        return {
            "company_research_data": CompanyResearchData(
                **state.company_research_data.__dict__,
                tavily_search=[],
            ),
